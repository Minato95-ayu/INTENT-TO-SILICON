"""
=============================================================================
FILE: create_vscode_page.py
PURPOSE: Generates VS Code extension page
=============================================================================
This file is part of the AAYU (Aayu) Intent-to-Silicon Programming Language.
The AAYU language enables developers to write code using natural language
intentions, which are compiled to optimized backend code.

For beginners: This file handles generates vs code extension page.
...
base_dir = r'd:\intent-to-silicon-research\INTENT-TO-SILICON\website\app\vscode'
...
with open(os.path.join(base_dir, 'page.tsx'), 'w', encoding='utf-8') as f:
    f.write(vscode_page_code)

print("Created VS Code Extension page.")
