...
int main() {
    ...
    _aayu_tokens = aayu_add(_aayu_tokens, ({ AayuValue _l = make_list(); aayu_list_append(&_l, ({ AayuValue _d = make_dict(); aayu_dict_set(&_d, "type", make_str("NUMBER")); aayu_dict_set(&_d, "value", make_num(100)); _d; })); _l; }));
    AayuValue _aayu_t = aayu_subscript(_aayu_tokens, make_num(0));
