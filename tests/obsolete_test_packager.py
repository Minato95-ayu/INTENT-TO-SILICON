...
import zipfile
import json
from tools.package_manager.manager.manager import PackageManager
from tools.package_manager.manager.exceptions import CircularDependencyError, ManifestError, ChecksumMismatchError, PackageNotFoundError
...
def create_mock_package(home_dir, name, version, deps=None, checksum="dummy"):
    ...
    from tools.package_manager.manager.security import SecurityInfo
