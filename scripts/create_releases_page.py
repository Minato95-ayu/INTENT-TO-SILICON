"""
=============================================================================
FILE: create_releases_page.py
PURPOSE: Generates release information pages
=============================================================================
This file is part of the AAYU (Aayu) Intent-to-Silicon Programming Language.
The AAYU language enables developers to write code using natural language
intentions, which are compiled to optimized backend code.

For beginners: This file handles generates release information pages.
...
base_dir = r'd:\intent-to-silicon-research\INTENT-TO-SILICON\website\app\releases'
...
with open(os.path.join(base_dir, 'page.tsx'), 'w', encoding='utf-8') as f:
    f.write(release_code)

print("Created Release Notes page.")
