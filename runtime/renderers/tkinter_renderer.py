...
from runtime.ui.display_list import DisplayList, DrawRect, DrawText, RegisterClickArea, DrawRoundedRect, DrawImage, DrawIcon
from runtime.events.queue import EventQueue, MouseClick
    ...
    def _on_click(self, event):
        ...
        for cx, cy, cw, ch, action in reversed(self.click_areas):
            if cx <= x <= cx + cw and cy <= y <= cy + ch:
                from runtime.events.queue import ActionEvent
