...
class Parser:
    ...
    def parse_type_annotation(self) -> Any:
        from type_nodes import NamedTypeNode
    ...
    def parse_function_declaration(self, is_exported: bool = False, visibility: str = "private") -> FunctionDeclNode:
        ...
        node = FunctionDeclNode(name=name, parameters=parameters, body=body, is_exported=is_exported, visibility=visibility)
    ...
    def parse_interface_declaration(self, is_exported: bool = False, visibility: str = "private") -> InterfaceDeclNode:
        ...
        self.consume("KEYWORD", "Expected 'end' to close interface block", "end")
        self.consume("DOT", "Expected '.' after 'end'")
        
        return InterfaceDeclNode(name=name, methods=methods, is_exported=is_exported, visibility=visibility)
