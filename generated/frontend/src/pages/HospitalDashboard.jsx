export default function HospitalDashboard() {
  return (
    <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">HospitalDashboard</h1>
      <p className="text-gray-600">
        This is a generated placeholder page for the <strong>HospitalDashboard</strong> intent. 
      </p>
