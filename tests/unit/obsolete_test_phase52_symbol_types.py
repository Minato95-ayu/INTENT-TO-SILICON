...
from compiler.semantic.symbols import TypeSource, SymbolKind
...
class TestSymbolTypeMetadata(unittest.TestCase):
    ...
    def test_symbol_defaults(self):
        ...
        from compiler.semantic.symbols import VariableSymbol, SymbolTable, ScopeType
    ...
    def test_symbol_kind_preserved(self):
        ...
        from compiler.semantic.symbols import FunctionSymbol, ParameterSymbol, SymbolTable, ScopeType
        scope = SymbolTable("test", ScopeType.GLOBAL)
