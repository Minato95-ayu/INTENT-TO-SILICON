  ...
  "overview": {
    ...
    body: (
      <>
        ...
        <p className="mb-4">AAYU introduces the <strong>Intent Engine</strong> at the core of the compiler pipeline. Instead of just parsing ASTs for syntax, AAYU builds an <em>Intent Graph</em>â€”a semantic understanding of your business logicâ€”and allows the <strong>BrainOS</strong> to automatically resolve infrastructure decisions (like databases, queues, and caching) at compile-time.</p>
  ...
  "runtime": {
    ...
    body: (
      <>
        ...
        <p className="mb-4">AAYU utilizes <strong>Fibers</strong>â€”lightweight, green threads multiplexed over OS threads via a work-stealing scheduler.</p>
      </>
    )
  }
};
...
const generateFallback = (slug: string) => ({
  ...
  description: `In-depth technical documentation for ${slug} is being compiled.`,
  body: (
    <>
