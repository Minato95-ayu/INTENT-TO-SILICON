...
base_dir = r'd:\intent-to-silicon-research\INTENT-TO-SILICON\website\app\brainos\live'
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {(stage > 0) && (
          <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 md:p-10 shadow-2xl space-y-12">
            ...
            {/* 1. Detected Domain */}
            <div className={	ransition-all duration-700 \}>
