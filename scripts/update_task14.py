...
phases_to_mark = [
    ...
    '[ ] Get Started and Documentation flow',
    '[ ] Ctrl + K Global Search',
    '[ ] Breadcrumbs, Prev/Next, Mobile Nav',
    '[ ] **Phase 2: AAYU Language Portal (/language)**',
    '[ ] Write real technical documentation for Compiler, Runtime, etc.'
]
