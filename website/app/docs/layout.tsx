...
import { Search, ChevronRight, Menu, GitBranch, BookOpen, Code2, Bot, Layers, CheckCircle2, Box } from "lucide-react";
...
export default function DocsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pt-16 flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <aside className="hidden md:block w-full md:w-64 lg:w-72 border-r border-white/10 bg-[#0a0a0a]">
          ...
          <div className="flex justify-end mb-4">
            <div className="group relative inline-flex">
              <Button disabled variant="outline" className="h-8 text-xs border-white/10 text-zinc-500 bg-transparent gap-2 cursor-not-allowed">
                <GitBranch className="w-3 h-3" /> Edit on GitHub
              </Button>
