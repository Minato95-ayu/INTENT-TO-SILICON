...
from compiler.ast.nodes import FunctionDeclNode, RecordDeclarationNode, InterfaceDeclNode, ExtensionDeclNode
from compiler.ast.nodes import GenericTypeNode
...
class TestGenerics(unittest.TestCase):
    def _run_pipeline(self, source: str) -> CompilerContext:
        ...
        from compiler.semantic.symbols import SymbolTable, ScopeType
