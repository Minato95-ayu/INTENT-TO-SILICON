...
def bytecode_to_dict(bytecode: Bytecode) -> Dict[str, Any]:
    ...
    if bytecode.reflection_info:
        from dataclasses import asdict
        reflection_info = asdict(bytecode.reflection_info)
...
def dict_to_bytecode(d: Dict[str, Any]) -> Bytecode:
    ...
    if "reflection_info" in d and d["reflection_info"]:
        from ir import ReflectionInfo
        bc.reflection_info = ReflectionInfo(**d["reflection_info"])
