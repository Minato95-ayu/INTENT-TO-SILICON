...
int main() {
    AayuValue _aayu_arr = make_list();
    aayu_list_append(&_aayu_arr, make_str("First item"));
    aayu_list_append(&_aayu_arr, make_str("Second item"));
    AayuValue _aayu_first = aayu_subscript(_aayu_arr, make_num(0));
    aayu_print(_aayu_first);
    AayuValue _aayu_length = aayu_len(_aayu_arr);
    aayu_print(make_str("Array length is:"));
    aayu_print(_aayu_length);
    AayuValue _aayu_char = aayu_subscript(_aayu_first, make_num(0));
    aayu_print(make_str("First char of first item:"));
    aayu_print(_aayu_char);
    AayuValue _aayu_file_content = aayu_read_file(make_str("test_arrays.aayu"));
    AayuValue _aayu_file_len = aayu_len(_aayu_file_content);
    aayu_print(make_str("Length of this file:"));
    aayu_print(_aayu_file_len);
    AayuValue _aayu_node = ({ AayuValue _d = make_dict(); aayu_dict_set(&_d, "type", make_str("Literal")); aayu_dict_set(&_d, "value", make_num(100)); _d; });
    AayuValue _aayu_type = aayu_subscript(_aayu_node, make_str("type"));
    AayuValue _aayu_val = aayu_subscript(_aayu_node, make_str("value"));
    aayu_print(make_str("Dict type:"));
    aayu_print(_aayu_type);
    aayu_print(make_str("Dict value:"));
    aayu_print(_aayu_val);
    return 0;
}
