...
class Workspace:
    ...
    def build(self, entry_file: Optional[str] = None):
        ...
        from compiler_context import CompilerContext, Diagnostics
        import os
        ...
        from passes.semantic.module_resolver import ModuleResolverPass
        from passes.semantic.import_binding import ImportBindingPass
        from passes.semantic.scope_builder import ScopeBuilderPass
        from passes.semantic.symbol_binding import SymbolBindingPass
        from passes.semantic.export_validation import ExportValidationPass
        from passes.semantic.semantic_validation import SemanticValidationPass
