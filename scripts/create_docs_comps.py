...
comp_dir = r'd:\intent-to-silicon-research\INTENT-TO-SILICON\website\components\docs'
...
with open(os.path.join(comp_dir, 'DocsComponents.tsx'), 'w', encoding='utf-8') as f:
    f.write(codeblock)

print("Created Docs Components (CodeBlock, ErrorBlock, PipelineDiagram, PageNav).")
