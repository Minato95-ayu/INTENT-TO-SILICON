  ...
  return (
    <Router>
      <nav style={{ padding: '1rem', borderBottom: '1px solid #ccc' }}>
        <strong>Aayu App</strong> | <Link to='/appointment'>Appointment</Link> | <Link to='/auth'>Auth</Link> | <Link to='/patient'>Patient</Link> | <Link to='/permission'>Permission</Link> | <Link to='/role'>Role</Link> | <Link to='/role_permission'>RolePermission</Link> | <Link to='/user'>User</Link> | <Link to='/user_role'>UserRole</Link> 
      ...
      <div style={{ padding: '1rem' }}>
        <Routes>
          ...
          <Route path='/permission/new' element={<PermissionForm />} />
          ...
          <Route path='/role_permission' element={<RolePermissionList />} />
          <Route path='/role_permission/new' element={<RolePermissionForm />} />
          <Route path='/role_permission/edit/:id' element={<RolePermissionForm />} />
          <Route path='/user' element={<UserList />} />
          <Route path='/user/new' element={<UserForm />} />
          <Route path='/user/edit/:id' element={<UserForm />} />
          <Route path='/user_role' element={<UserRoleList />} />
          <Route path='/user_role/new' element={<UserRoleForm />} />
          <Route path='/user_role/edit/:id' element={<UserRoleForm />} />
        </Routes>
      </div>
    </Router>
  );
