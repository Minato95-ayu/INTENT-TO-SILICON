...
filepath = r'd:\intent-to-silicon-research\INTENT-TO-SILICON\website\lib\mdx.ts'
...
export function getDocBySlug(category: string, slug: string): DocData | null {
  const fullPath = path.join(DOCS_DIR, category, \.mdx);
...
print("Created MDX parsing utility.")
