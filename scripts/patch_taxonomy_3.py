...
root_lemmas = {
    ...
    "performance_frustration": ["bore", "hang", "slow", "atak", "load nahi", "bekar", "ghoom", "fun", "khushi", "maza", "khush", "pareshan"],
...
print("Taxonomy patched with EVEN MORE root_lemmas!")
