...
root_lemmas = {
    ...
    "navigation_confusion": ["confus", "uljhan", "samajh nahi", "kaha click", "pata nahi"],
    "performance_frustration": ["bore", "hang", "slow", "atak", "load nahi", "bekar", "ghoom"],
    "trust_deficit": ["trust", "safe", "privacy", "secure", "private", "leak", "dar"],
...
print("Taxonomy patched with root_lemmas!")
